...
object Cash:
  ...
  private def buildTicket(w: World, train: Train, seat: Int, cls: TicketClass, baggageKg: Int, price: Int): State[World, Option[Ticket]] =
  ...
  private def bookSeat(w: World, train: Train, seat: Int, cls: TicketClass, baggageKg: Int, price: Int): State[World, Option[Ticket]] =
    ...
    else buildTicket(w, train, seat, cls, baggageKg, price)
